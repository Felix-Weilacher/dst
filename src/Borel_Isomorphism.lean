...
--Say a measurable space is countably generated if the sigma algebra can be generated by a countable set
...
[h : countable_generated α] [measurable_singleton_class α] : 
